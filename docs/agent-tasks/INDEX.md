...
| TASK-011 | ExceptionsModule AppLogger peer + deprecated facades | technical      | proposed | `docs/agent-tasks/TASK-011-exceptions-peer-and-deprecated-facades.md` |

## Rules

- IDs are sequential and must never be reused.
- `TASK-001` is retired; the next available ID is `TASK-012`.
